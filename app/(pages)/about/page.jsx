    ...
    <div>
      ...
      >
        ...
        >
          <h3>BIOGRAPHY</h3>
          <p>
            Hi, I m Ihab Yousef, a web developer and UI/UX designer with a
            passion for creating beautiful, functional, and user-centered
            digital experiences. With 2 years of experience in the field. I am
            always looking for new and innovative ways to bring my client s
            visions to life.
          </p>
          <p>
      ...
      >
        <Typography
          component="h1"
          sx={{ textAlign: "center", color: "var(--white)", margin: "1rem 0" }}
          variant="h1"
        >
          Skills
        </Typography>
