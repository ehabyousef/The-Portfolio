...
const Navbar = (props) => {
    ...
    const drawer = (
        <Box sx={{ textAlign: 'center' }}>
            ...
            >
                <CloseIcon sx={{ width: '40px', height: '40px', color: 'var(--white)' }} />
            </div>
            <Divider />
            <Box sx={{
                ...
                <Link onClick={handleDrawerToggle} className={style.navlist} href='/'>
                    <button className={style.button}>
                        <span className={style.span}>Home</span>
                        <span className={style.span}>Home</span>
                    </button>
                </Link>
                <Link onClick={handleDrawerToggle} className={style.navlist} href='/about'>
                    <button className={style.button}>
                        <span className={style.span}>About</span>
                        <span className={style.span}>About</span>
                    </button>
                </Link>
                <Link onClick={handleDrawerToggle} className={style.navlist} href='/projects'>
                    <button className={style.button}>
            ...
            <div class={style.parent}>
                <div className={style.child}>
                    <Link href='https://www.linkedin.com/in/ehabyousef/' target="_blank" className={style.bot}>
                        <svg
                ...
                <div className={style.child}>
                    <Link href='https://www.instagram.com/ehab.yousef.66/?utm_source=qr&igshid=MThlNWY1MzQwNA%3D%3D' target="_blank" className={style.bot}>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            height="1em"
                            viewBox="0 0 448 512"
                ...
                <div className={style.child}>
                    <Link href='https://github.com/ehabyousef' target="_blank" className={style.bot}>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            height="1em"
                            viewBox="0 0 496 512"
                ...
                <div className={style.child}>
                    <Link href='https://www.facebook.com/profile.php?id=100080623690922' target="_blank" className={style.bot}>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            height="1em"
                            viewBox="0 0 320 512"
    ...
    return (
        <Box sx={{ display: 'flex', maxHeight: '8vh', transition: '.3s', position: 'relative' }}>
            <dev className={style.appbar}  sx={{ backgroundColor: "var(--dark-color)", position: "fixed", boxShadow: "none", alignItems: "center", padding: '10px' }}>
